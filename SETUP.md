...
1. If you'd like users to have tools like 'trigger pipeline' and 'create pull request' then flip the Read Only mode toggle.
2. Go to the tools tab and select or deselect tools. Only selected tools can be seen and used by users.
